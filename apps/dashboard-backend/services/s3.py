...
def _normalize_metrics_5m_object(obj: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "risk_score_min_at": risk_score.get("min_at") if isinstance(risk_score.get("min_at"), str) else None,
        "risk_score_max": _number_or_none(risk_score.get("max")),
        "risk_score_max_at": risk_score.get("max_at") if isinstance(risk_score.get("max_at"), str) else None,

...
# Origin: S3 dashboard-web bucket via OAC (no public S3 access)
# Alias: dashboard.<domain> (ACM cert in us-east-1)
# SPA routing: 403/404 → index.html (client-side routing support)
# ===========================================================================
